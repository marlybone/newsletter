import { SkeletonOne, SkeletonTwo, SkeletonThree, SkeletonFour, SkeletonFive } from "./bentoskeleton"

export const authors = [
    {id: "0",
     url: "/mainimg.webp",
      name: "Marlon Stevenson",
       color: "bg-gradient-to-r from-fuchsia-700 to-rose-400 bg-radial bg-opacity-60 h-20 w-20 flex items-center justify-center rounded-full blur transition-all",
    ...
    {id: "1",
     url: "/bgimg.webp",
      name: "Carlos Rimba",
       color: "bg-gradient-to-r from-sky-700 to-teal-400 bg-radial bg-opacity-90 h-20 w-20 flex items-center justify-center rounded-full blur transition-all",
