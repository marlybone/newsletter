...
export default function Navbar() {
  ...
  const navbarClasses = `mt-2 flex-row opacity-100 fixed top-0 left-0 w-full z-50 h-16 ${visible ? 'border border-transparent shadow-md backdrop-filter backdrop-blur-sm' : 'border-gray-200'}`;
