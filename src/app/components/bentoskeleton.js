  ...
  return (
    ...
    >
      ...
      >
        ...
        <motion.p variants={variantOne}>
          stories, I hope to inspire others exploring similar career
          transformations.
        </motion.p>
      </motion.div>
      <motion.div>
        ...
        >
          ...
          <Link href="https://github.com/marlybone" target="_blank">
            <motion.svg
              initial="hidden"
              animate="visible"
              variants={variants}
          ...
          <Link href="https://twitter.com/mRockSwe" target="_blank">
            <motion.svg
              initial="hidden"
              animate="visible"
              variants={variants}
...
export const SkeletonFive = ({}) => {
  ...
  return (
    <motion.div className="border-gray-200 md:col-span-2 row-span-1 rounded-xl group/bento hover:shadow-xl transition duration-200 shadow-input dark:shadow-none dark:bg-black dark:border-white/[0.2] bg-white border justify-between flex flex-col space-y-4">
      <motion.div className="py-4 mx-20 border border-gray-400 rounded-full mt-4">
        <motion.h1
          animate={{ fontSize: 80, x: 100 }}
