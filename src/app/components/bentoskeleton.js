  ...
  return (
    ...
    >
      ...
      >
        {content.map((item, i) => (
                <motion.p 
                className="mr-1 mx-px my-px font-normal text-xl"
                key={i}
                >{item}</motion.p>
        ))}
      </div>
